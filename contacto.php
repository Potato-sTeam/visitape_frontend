    ...
    <body>
        ...
        <div class="dashboard-content">
            <header class="menu" id="fixed">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
                        ...
                        <div
                            class="collapse navbar-collapse nav-principal"
            ...
            <footer id="footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-dm-6 col-lg-3 margin-gral1 margin-gral2 wrap-colum">
                            ...
                            <form class="form-footer" method="POST" action="#">
                                ...
                                <p style="font-weight: 700; font-size: 11px; font-style: oblique">
                                    NOTA: Para enviarte muchas novedades y saber que eres nuestro
                                    amigo
                                </p>
                            </form>
                        </div>
                ...
                <p class="text-center copyright-footer">
                    Potato's Team 2021 - Todos los derechos reservados
                </p>
            </footer>
        </div>
